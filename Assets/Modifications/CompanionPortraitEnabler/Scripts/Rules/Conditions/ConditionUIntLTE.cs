...
{
	public class ConditionUIntLTE : IConditionInstance { public uint value; public int index; 
	...
	public class TracingConditionUIntLTE : IConditionInstance { ConditionUIntLTE wrapped; 
	    public TracingConditionUIntLTE(int i, uint value) { wrapped = new ConditionUIntLTE(i,value); }
